...
# Я не понял для чего нужен класс класс point по условию, поэтому я в него добавил 
#init, ведь по сути зачем прописывать его в каждом классе если можно все сделать в родительском
#классе. 
class Point:
...
#Про этот класс в задании вроде кк тоже ничего не сказано, поэтому тут список объектов, и метод
#обращения к ним, если можно так сказать
class Figure(Point):
...
#А вот и  список, как и сказано в задании
...
#хотя я до сих пор не понял условие